const app = {
    ...
    init() {
        ...
        if (typeof HubStorage !== 'undefined') {
            HubStorage.recordSession('modelos-negocios');
        }
    },
    ...
    showTestResults() {
        ...
        if (typeof HubStorage !== 'undefined' && this.state.currentTestId) {
            const before = HubStorage.getCourse('modelos-negocios').tests[this.state.currentTestId];
            const prevBest = before ? before.bestScore : null;
            HubStorage.saveTestResult('modelos-negocios', this.state.currentTestId, this.state.score, total);
